<template>
    ...
    <v-divider></v-divider>
    <v-list nav>
        <v-list-item prepend-icon="mdi-lightbulb-group" title="设备管理" value="device" href="#/"></v-list-item>
        <v-list-item prepend-icon="mdi-calendar-clock" title="定时任务" value="timing" href="#/timing"></v-list-item>
        <v-list-item prepend-icon="mdi-view-quilt" title="情景模式" value="scene" href="#/scene"></v-list-item>
        <v-list-item prepend-icon="mdi-account-box-multiple" title="账户管理" value="account"
            href="#/account"></v-list-item>
