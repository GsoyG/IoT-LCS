...
// Application Events
#define SMARTLIGHT_END_DEVICE_REJOIN_EVT 0x0001
#define SMARTLIGHT_LED_BLINK_EVT 0x0002
#define SMARTLIGHT_TEMP_HUMI_EVT 0x0004
#define SMARTLIGHT_DIMMER_AUTO_EVT 0x0008
